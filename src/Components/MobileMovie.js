...
const Mobilemovie = ({title, poster_path, overview, release_date, vote_average, vote_count, id}) => {
  ...
  return (
      ...
      <div>
        ...
        <Box sx={style}>
            <Typography id="modal-modal-title" sx={{ color: "#f4f1e9" }} variant="h6" component="h6">
              {title}
            </Typography>
